...
# 项目根目录和测试用例目录
project_root = "."
testcases_root = os.path.join(project_root, "test", "python", "testcases", "parser-error-private")
...
if __name__ == "__main__":
    ...
    testcases_root = os.path.join(project_root, "test", "python", "testcases", "parser-error-public")
