...
public class GetIntStmtContext extends Context {
    ...
    public void add(Context context) {
        ...
        if (context instanceof LValContext) {
            ...
            ASSERT(false, "GetInt only accepts LValContext");
        }
    }
    ...
    public void add(TerminalContext ctx) {
        ...
        if (ctx.getToken().is(ASSIGN)) {
            ...
            ASSERT(false, "GetInt only accepts ASSIGN or SEMICN or GETINTTK or LPARENT or RPARENT");
        }
    }
